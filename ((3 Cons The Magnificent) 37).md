...
A7: It says to cons the car of l5 -soy- onto the value of
...
Q39: We now have a value of (insertR a5 a2 (cdr l5))
     where a5 is soy, a2 is hot and l5 is (tomato sauce).
This value is (sauce). What next?
A39: We cons tomato onto the value of (insertR a5 a2 (cdr l5))
where a5 is soy, a2 is hot and (cdr l5) was (sauce).
Now that the value of (insertR a5 a2 l5) is (tomato sauce)
when l5 is (tomato sauce).

Q40: Cons and onto the value of (insertR a5 a2 (cdr l5))
where a5 is soy, a2 is hot and (cdr l5) was (tomato sauce).
A40: (and tomato sauce)

Q41: Cons sauce onto the value of (insertR a5 a2 (cdr l5))
where a5 is soy, a2 is hot and (cdr l5) was (and tomato sauce).
A41: (sauce and tomato sauce)

Q42: Cons soy onto the value of (insertR a5 a2 (cdr l5))
where a5 is soy, a2 is hot and (cdr l5) was (sauce tomato sauce).
A42: (soy sauce and tomato sauce).
